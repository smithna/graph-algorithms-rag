...
| 0 | Cold open — the failure | `baseline.py` | ✅ verified live; **slides drafted** — [`docs/section-00-slides.md`](section-00-slides.md). Open: question choice (defaults to `charbonneau-role`, same as 5.1 — deliberate callback, needs sign-off) and a vector-only demo entry point (tiny flag/script, the section's one code gate) |
| 1 | What is a graph? | none | **slides drafted** — [`docs/section-01-slides.md`](section-01-slides.md) |
| 2 | What is Graph RAG / evidence | none (sources gathered) | **slides drafted** — [`docs/section-02-slides.md`](section-02-slides.md); verify NICD coarse-truthfulness values (−31/−49) against the PDF before the scaffold |
| 3 | Roadmap | none | **slides drafted** — [`docs/section-03-slides.md`](section-03-slides.md); §5's row tracks that section's pending title |
