...
The paper the talk's numbers are checked against — Wedge, Stutter, Dixon &
Cała (NICD, Newcastle University), *Reducing Hallucinations in Complex
Question Answering using Simple Graph-based Retrieval-Augmented Generation*
— is on [arXiv](https://arxiv.org/abs/2606.05901); their code is at
[github.com/NICD-UK/graph-based-rag-qa](https://github.com/NICD-UK/graph-based-rag-qa).
